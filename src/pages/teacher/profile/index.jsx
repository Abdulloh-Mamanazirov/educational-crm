...
const TeacherProfile = () => {
  ...
  const initialData = {
    ...
    description: "Dedicated educator with a passion for mathematics.",
    gender: "Female",
    nationality: "American",
    email: "janesmith@example.com",
    address: "456 College Ave, University Town, USA",
    certifications: "Ph.D. in Mathematics",
  };
      ...
      <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow mb-6">
        <div className="flex items-center">
          ...
          <div className="relative mr-6">
            <Avatar size={200} src={formData.photo} alt="Teacher Avatar" />
            {isEditing && (
              <Upload
                name="photo"
                  ...
                  {!isEditing ? (
                    ...
                    <div className="space-y-4 dark:text-white">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          <strong>Field:</strong> {formData.field_id}
                        </div>
                        <div>
                    ...
                    >
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <Form.Item
                          label={<span className="dark:text-white">Field</span>}
                          name="field_id"
                        >
                          <Input />
                        </Form.Item>
